# Generated by Django 2.2.5 on 2019-12-03 20:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', docker.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Docker',
            fields=[
                ...
                ('proto_path', models.CharField(max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='experiments', to='docker.Docker')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='graphs', to='docker.Experiment')),
                ('kind', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='graphs', to='docker.GraphType')),
            ],
        ),
        migrations.CreateModel(
            name='ElementType',
            fields=[
                ...
                ('docker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elements_type', to='docker.Docker')),
                ('element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='types', to='docker.Element')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='dockers',
            field=models.ManyToManyField(related_name='users', to='docker.Docker'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
